...
<body>
		...
		<div class="content mt-3">
			<div class="animated fadeIn">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							<div id="div_text">	新增款项：</div>
							<input type="text" style="width: 100%;float: left;" id="value_text" name="value" class="form-control">
							<div id="div_text">	金额（元）：</div>
							<input type="text" style="width: 100%;float: left;" id="remark_text" name="remark" class="form-control">
						</div>
							</div>
							<div class="card-body">
							</div>
    ...
    function submit() {
        ...
        // 读取 text
        $.ajax({
            url:"/yhz/dictionary/dictionary-add",
            type:"post",
            data:{
            	value:valueText,
            	remark:remarkText
